<template>
    <div class="container-fluid">
                    ...
                    <div class="client_box">
                        ...
                        <div class="client_height tableone">
                            <table>
                                ...
                                <tbody>
                                    <tr :key="allemployeeData.id" v-for="allemployeeData in employeeData">
                                        <td>
                                            {{ allemployeeData.user.firstname+' '+allemployeeData.user.lastname }}
                                        </td>
                                       
                                        <td>
                                            {{ allemployeeData.user.email }}
                                        </td>
                                        <td>
                                            {{ allemployeeData.user.phone }}
                                        </td>
                                       
                                        <td>
                                            <ul>
                                                <li v-for="skill in employeesSkillsData[allemployeeData.id]" :key="skill.id">
                                                    {{ skill.skills }}
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
                                            {{ allemployeeData.category.category }}
                                        </td>
                                        <td>
                                            <button @click="downloadCV(allemployeeData.cv)">
                                        ...
                                        <td>
                                            <div class="td_flex d-flex align-items-center">
                                                <!-- view icon -->
                                                <router-link :to="'/view-employee/'+allemployeeData.id">
                                                ...
                                                <!-- edit icon -->
                                                <router-link :to="'/edit-employee/'+allemployeeData.id">
                                                ...
                                                <!-- delete icon -->
                                                <button to="" data-bs-toggle="modal" data-bs-target="#exampleModal"  @click="setSelectedUserId(allemployeeData.user.id)">
                                        ...
                                        <td>
                                            <div class="td_flex d-flex align-items-center">
                                                <a :href="'https://jobboard.works-reddensoft.com/'+allemployeeData.user.id+'/OneClickLogin'" target="_blank">
        ...
        <div class="modal add_redeem_div add_client_delete fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
import {useToast} from 'vue-toast-notification';
    ...
    computed: {
        ...mapState('userDataModule', ['employeeData', 'employeesSkillsData'])
    },

    methods: {

        ...mapActions('userDataModule', ['getEmployeeDataFromApi', 'deleteEmployeeData', 'downloadTheCV']), 
        ...
        deleteEmployee(){
            ...
            if(delValue === 'delete' && delValue != ''){
                this.deleteEmployeeData(this.selectedUserId);
        ...
        downloadCV(cvFileName) {
            // console.log(cvFileName)
            this.downloadTheCV(cvFileName);
        },
