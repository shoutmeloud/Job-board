    ...
    <div class="container-fluid">
                    ...
                    <div class="client_box">
                        ...
                        <div class="client_height tableone">
                            <table>
                                ...
                                <tbody>
                                    <tr :key="allData.id" v-for="allData in skillsData">
                                        <td>
                                            {{ allData.skills }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="td_flex d-flex align-items-center">
                                                ...
                                                <!-- edit icon -->
                                                <router-link :to="'/edit-skills/'+allData.id">
                                                ...
                                                <!-- delete icon -->
                                                <button to="" data-bs-toggle="modal" data-bs-target="#exampleModal"  @click="setSelectedId(allData.id)">
        ...
        <div class="modal add_redeem_div add_client_delete fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <form @submit.prevent="deleteSkills">
...
import {useToast} from 'vue-toast-notification';
    export default {
        ...
        computed: {
            ...mapState('userDataModule', ['skillsData'])
        },

        methods: {
            ...mapActions('userDataModule', ['getSkillDataFromApi', 'deleteSkillsData']),        
            setSelectedId(id) {
                this.selectedId = id;
            ...
            deleteSkills(){
                ...
                if(delValue === 'delete' && delValue != ''){  
                    this.deleteSkillsData(this.selectedId);
                    document.getElementById("closebutton").click();
                    this.getSkillDataFromApi();
                }else{
