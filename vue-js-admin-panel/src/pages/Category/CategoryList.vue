                    ...
                    <div class="client_box">
                        ...
                        <div class="client_height tableone">
                            <table>
                                ...
                                <tbody>
                                    <tr :key="allData.id" v-for="allData in categoryData">
                                        <td>
                                            {{ allData.category }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="td_flex d-flex align-items-center">
                                                ...
                                                <!-- edit icon -->
                                                <router-link :to="'/edit-category/'+allData.id">
...
import {useToast} from 'vue-toast-notification';
    ...
    computed: {
        ...mapState('userDataModule', ['categoryData'])
    },

    methods: {
        ...mapActions('userDataModule', ['getCategoryDataFromApi', 'deleteCategoryData']),        
        setSelectedId(id) {
            this.selectedId = id;
        ...
        deleteCategory(){
            ...
            if(delValue === 'delete' && delValue != ''){
                this.deleteCategoryData(this.selectedId);
