<template>
    <div class="container-fluid">
                            ...
                            <table>
                                ...
                                <tbody v-if="projectlista">
                                    <tr v-for="(user, index) in projectlista.data" :key="index">
                                        ...
                                        <td>
                                            <router-link :to="{name:'ViewProject', params: { slug: user.id } }" v-html="user.projectdescription"></router-link>
                                        </td>
                                        ...
                                        <td>
                                            <div class="td_flex d-flex align-items-center">
                                                <router-link :to="{name:'ViewProject', params: { slug: user.id } }">
                                                    <span>
                                                ...
                                                <router-link :to="{name:'EditProject', params: {slug: user.id}}">
                                                    <span>
                                                ...
                                                <!-- <button>
                                                 ...
                                                 <button to="" data-bs-toggle="modal" data-bs-target="#exampleModal"  @click="setSelectedProjectId(user.id)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="16px" height="16px" fill="#21232c"><path d="M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z"></path></svg>
                                                </button>
                                            </div>
                                        </td>
        ...
        <div class="modal referral_modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
import moment from 'moment';
    ...
    methods: {
        ...mapActions('projectsDataModule', ['getProjectsList','deleteProjectData']),
        ...
        deleteProject(){
            ...
            if(delValue === 'delete' && delValue != ''){
                this.deleteProjectData(this.selectedProjectId);
    ...
    mounted(){
        console.log('User List',this.ProjectData);
    } ,

    computed: {
        ...mapGetters('projectsDataModule', ['ProjectData']),

        projectlista(){
            return this.ProjectData
        },
        total_no_page(){
             return this.ProjectData.last_page
        },
