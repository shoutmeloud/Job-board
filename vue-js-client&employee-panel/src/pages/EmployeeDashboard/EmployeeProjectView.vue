                                        ...
                                        <form v-if="details">                                            
                                            ...
                                            <div class="input_sub_box">
                                                ...
                                                <div class="project_span">
                                                    <div class="project_scroll" v-html="details.projectdescription">
                                            ...
                                            <!-- <div class="input_sub_box" v-if="details.documentfile">
                                                <label for="">Download Document :</label>
                                                <button type="button" class="pdf_vieweer" data-bs-toggle="modal" data-bs-target="#exampleModal">Pdf Viewer</button>
                                            </div> -->
                                            ...
                                            <!-- <div class="row">
                                                <div class="col-md-12">
                                                    <div v-if="modalshow" class="profile-model-container" :class="{ open: isOpen }">
                                                        <div class="profile-content">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="skills-sec">
                                                                        ...
                                                                        <a class="btn btn-danger" role="button" @click="cvfiledownload(this.modaldata[0].employee_profile.profile_image)">
                                                                        Download
                                                                        </a>
                                                                </div>
                                                            </div>
...
export default {
    ...
    methods: {
        ...mapActions('projectsDataModule', ['getEmployeeProjectDetails','downloadTheCV']),
    ...
    computed: {
        ...mapGetters('projectsDataModule', ['EmpProjectDetails']),
        // details(){
    ...
    created() {
        ...
        this.getEmployeeProjectDetails(querydata)
    } ,
    mounted(){
    ...
    watch:{
        EmpProjectDetails(){            
            this.details=this.EmpProjectDetails;
            this.details.documentfile = JSON.parse(this.EmpProjectDetails.documentfile);
        }
...
<style scoped>
 ...
 .profile-model-container {
  ...
  right: 0; /* Initially hide the model to the right */
  width: 400px;
  bottom: -600px;
  height: 600px;
...
.profile-model-container.open {
  bottom: 0; /* Show the model when open */
}
